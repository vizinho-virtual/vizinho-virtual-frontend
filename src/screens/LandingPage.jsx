        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center gap-3 ml-4">
              ...
              <Link to="/register" className="px-5 py-2.5 bg-primary text-forest text-sm font-bold rounded-lg shadow-lg shadow-primary/20 hover:scale-105 transition-transform inline-block">
                Get Started
              </Link>
            </div>
          </div>
